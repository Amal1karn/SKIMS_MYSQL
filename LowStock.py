...
class lowSTOCK_class:
    def __init__(self, root, enable_button):
        ...
        Label(self.title_frame, text="Low On Stock", font=("times new roman", 30, "bold"),
        ...
        self.closebtn = Button(self.title_frame, text="Close", font=("arial", 15, "bold"), bg="#0F148C",
                               cursor="hand2", relief=RAISED, fg="white", bd=8, command=self.close_low_stock)
